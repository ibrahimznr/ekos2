    ...
    <div className="min-h-screen flex" style={{ background: 'linear-gradient(135deg, #f0f4f8 0%, #e2e8f0 100%)' }}>
      ...
      <main className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'md:ml-64' : 'md:ml-20'} mt-14 md:mt-0`}>
        ...
        <header className={`hidden md:flex sticky top-0 z-30 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm h-14 items-center justify-between px-6`}>
          ...
          {/* Right side - Notifications, Feedback, Admin Panel, User */}
          <div className="flex items-center gap-4">
            ...
            {user.role !== 'admin' && (
              ...
              >
                ...
                <span className="text-sm font-medium hidden lg:inline">Geri Bildirim</span>
              </button>
            )}
            ...
            <DropdownMenu open={notificationsOpen} onOpenChange={setNotificationsOpen}>
              ...
              <DropdownMenuContent align="end" className="w-80 max-h-96 overflow-hidden">
                <div className="px-3 py-2 border-b border-gray-100 flex items-center justify-between">
                  <p className="font-semibold text-gray-800">Bildirimler</p>
                  {unreadCount > 0 && (
                    <button
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((notif) => (
                      <div
                        ...
                        className={`px-3 py-3 hover:bg-gray-50 cursor-pointer border-b border-gray-50 ${
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <p className={`text-sm ${!notif.is_read ? 'font-semibold' : 'font-medium'} text-gray-800 truncate`}>
                                {notif.title}
                              </p>
                              {!notif.is_read && (
